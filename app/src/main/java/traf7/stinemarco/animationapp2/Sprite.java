...
class Sprite extends RectF {
    ...
    public static final int BMP_COLUMNS = 5;
    public static final int BMP_ROWS = 4;
    public static final int DOWN=2, LEFT=1, RIGHT=3, UP=0;
    public int dX, dY, color;
    public Canvas c;
//    public float l,r,t,b;
    public Bitmap bitmap;
    public int currentFrame=0, iconWidth, iconHeight, animationDelay=20;
        ...
        if(bitmap==null) {//if no bitmap exists draw a red circle
            ...
            canvas.drawBitmap(bitmap,src, this,null); //draw an image
                ...
                if(dX>0)
                {
                    ...
                    canvas.drawLine(left-100,top-100,left,top,paint);
                }
                else {

                    paint.setColor(color);
                    canvas.drawLine(right+100,top-100,right,top,paint);
                }
